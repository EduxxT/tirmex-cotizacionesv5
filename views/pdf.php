...
if (empty($productos)) {
    ...
    foreach ($productos as $producto) {
        ...
        $pdf->Cell(25, 7, iconv("UTF-8", "ISO-8859-1", "$" . number_format($producto['precio_producto'], 2) . " USD"), 'L', 0, 'C');
        $pdf->Cell(19, 7, iconv("UTF-8", "ISO-8859-1", "$0.00 USD"), 'L', 0, 'C'); 
        $pdf->Cell(32, 7, iconv("UTF-8", "ISO-8859-1", "$" . number_format($subtotal, 2) . " USD"), 'L', 0, 'C');
    ...
    $pdf->Cell(32, 8, iconv("UTF-8", "ISO-8859-1", "$" . number_format($total, 2) . " USD"), 1, 0, 'C', true); 
}
